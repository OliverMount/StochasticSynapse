...
Thanks to the netstim_inhpoisson.mod file and to be honest I have not fully understood their implementation. However, it works in CoreNEURON in the same way as NEURON.
